...
<head>
    <title>CandyLux | Chocolate</title>
</head>
...
<main>
    ...
    <div class="container p-3 mb-0 bg-dark text-light">
        ...
        <div class="container-fluid d-flex justify-content-between px-5 py-5">
            ...
            <img src="./img/cupcake3.png" width="700px" alt="chocolate">
        ...
        <div class="container p-5 pt-0 pb-5">    
            ...
            <br/>
            A delícia acima tem sabor de chocolate!
            </div>
            </div>
    ...
    <div class="container pt-0 mb-4 bg-light rounded-3">
        ...
        <div class="container px-5 py-5">
            ...
            <h1>Delivery</h1> <br>
            <p class="">Se quiser receber em casa, você também será atendido! <br></p>
